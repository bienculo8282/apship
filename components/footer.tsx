            ...
            <div className="col-md-6">
              <div className="site-branding-text">
                <p className="site-title-footer">
                  <a href="https://hemdohoa.com/" rel="home">Daily Express</a>
                </p>
          ...
          <div className="row">
            <div className="col-md-6 text-xs">
              <p>
                ...
                <span className="sep"> | </span> Theme: Newses by <a href="https://hemdohoa.com/" rel="designer">Themeansar</a>.
              </p>
            </div>
            <div className="col-md-6 text-right footer-menu text-xs">
              <ul className="info-right">
                <li className="nav-item menu-item active">
                  <a className="nav-link " href="https://hemdohoa.com/" title="Home">Home</a>
                </li>
                <li className="nav-item menu-item page_item dropdown page-item-49">
                  <a className="nav-link" href="https://hemdohoa.com/ccpa-california-consumer-privacy-act/">CCPA – California Consumer Privacy Act</a>
                </li>
                <li className="nav-item menu-item page_item dropdown page-item-46">
                  <a className="nav-link" href="https://hemdohoa.com/dmca/">DMCA</a>
                </li>
                <li className="nav-item menu-item page_item dropdown page-item-39">
                  <a className="nav-link" href="https://hemdohoa.com/privacy-policy/">Privacy Policy</a>
                </li>
                <li className="nav-item menu-item page_item dropdown page-item-43">
                  <a className="nav-link" href="https://hemdohoa.com/terms-of-use/">Terms of Use</a>
                </li>
              </ul>
            </div>
          </div>
